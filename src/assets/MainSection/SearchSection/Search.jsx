...
function Search() {
  ...
  useEffect(() => {
    handleFilter(); // Call the filter function when any of the filter criteria changes
  }, [status, originalLaunch, type, setFilteredCapsules]);

  return (
    <div className="p-4 sm:p-6 md:p-8 lg:p-4">
  <h2 className="text-white text-sm sm:text-xl md:text-2xl lg:text-3xl font-semibold mb-4">Capsules</h2>
